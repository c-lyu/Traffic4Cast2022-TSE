...
ks = [1, 2, 5, 10, 50]
x_sg_speed = read_speed_features(PROCESSED, city, ks, 'train', y.shape, p_speed, missing=True)
...
ks = [2, 5, 10, 30, 50, 100]
x_knn_test = read_knn_features(PROCESSED, city, ks, 'test', y.shape, p_knn, missing=True)
# supersegment speed statistics
ks = [1, 2, 5, 10, 50]
x_sg_speed = read_speed_features(PROCESSED, city, ks, 'test', y.shape, p_speed, missing=True)
